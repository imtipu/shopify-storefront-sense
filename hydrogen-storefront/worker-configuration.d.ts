/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f6ae005bbf18f352c81da6e487b93b45)
// Runtime types generated with workerd@1.20260114.0 2024-12-01 nodejs_compat
export {};
declare global {
	...
	const PUBLIC_CUSTOMER_ACCOUNT_API_CLIENT_ID: string;
	const PUBLIC_CUSTOMER_ACCOUNT_ID: string;
	const PUBLIC_CHECKOUT_DOMAIN: string;
	const PUBLIC_STOREFRONT_ID: string;
	const PUBLIC_CUSTOMER_ACCOUNT_API_URL: string;
	const TUNNEL_DOMAIN: string;
	const PUBLIC_TUNNEL_DOMAIN: string;
	const SHOP_ID: string;
	const GENERATE_SOURCEMAP: string;
	const VERCEL_OIDC_TOKEN: string;
